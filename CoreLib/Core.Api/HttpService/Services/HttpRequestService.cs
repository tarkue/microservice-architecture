...
using Core.Api.TraceLogic.Interfaces;
    ...
    private static HttpContent PrepairContent(object body, ContentType contentType)
    {
        switch (contentType)
        {
            case ContentType.ApplicationJson:
            {
                ...
                serializeSettings.ReferenceHandler = ReferenceHandler.IgnoreCycles;
                serializeSettings.DefaultIgnoreCondition = JsonIgnoreCondition.WhenWritingNull;

                var serializedBody = JsonSerializer.Serialize(body, options: serializeSettings);
